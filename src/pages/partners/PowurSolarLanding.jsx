    ...
    >
      ...
      <section className="py-24 relative overflow-hidden bg-black text-center">
        ...
        >
          ...
          <a href={affiliateLink} onClick={() => logTelemetry('partner_referral_click', { partnerName: 'Powur Solar', placement: 'footer_button', destinationUrl: affiliateLink })} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-12 py-5 bg-axim-gold text-black font-black uppercase tracking-widest text-xs hover:bg-white transition-colors shadow-[0_0_30px_rgba(255,234,0,0.3)] rounded-sm">
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-[#050505] border-t border-white/10 p-4 z-50 flex items-center justify-between">
        ...
        <a
          href={affiliateLink}
          onClick={() => logTelemetry('partner_referral_click', { partnerName: 'Powur Solar', placement: 'sticky_mobile', destinationUrl: affiliateLink })}
          target="_blank"
