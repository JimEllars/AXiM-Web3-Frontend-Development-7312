  ...
  const agencySchema = {
    ...
    >
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-[#050505] border-t border-white/10 p-4 z-50 flex items-center justify-between">
        ...
        <a
          href={affiliateLink}
          onClick={() => logTelemetry('partner_referral_click', { partnerName: 'Powur Join', placement: 'sticky_mobile_cta', destinationUrl: affiliateLink })}
          target="_blank"
