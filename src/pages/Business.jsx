    ...
    <div className="min-h-screen bg-bg-void text-white font-sans selection:bg-axim-gold/30">
      ...
      <section className="py-12 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          {/* SpeedReport */}
          <a href="https://speedreport.org" target="_blank" rel="noopener noreferrer" className="group relative bg-[#050505] border border-white/10 p-6 rounded-sm hover:border-axim-gold/50 transition-all duration-300 overflow-hidden shadow-xl hover:bg-white/5">
            <div className="absolute inset-0 bg-gradient-to-br from-axim-gold/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            <SafeIcon icon={LuIcons.LuActivity} className="w-8 h-8 text-axim-gold mb-4" />
            <h3 className="text-lg font-black uppercase tracking-wider mb-2 text-white">SpeedReport.org</h3>
            <p className="text-xs text-zinc-400 font-medium">Enterprise Network Diagnostics & SLA Verification.</p>
          </a>
