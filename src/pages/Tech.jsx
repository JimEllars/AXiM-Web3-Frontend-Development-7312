      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-[#050505] border border-white/10 p-6 rounded-sm shadow-lg flex flex-col hover:border-axim-gold/30 transition-colors">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#050505] border border-white/10 p-6 rounded-sm shadow-lg flex flex-col hover:border-axim-purple/50 transition-colors group">
        ...
        <section>
          <div className="bg-[#0A0A0A] border border-axim-green/30 p-8 rounded-sm shadow-2xl relative overflow-hidden group">
