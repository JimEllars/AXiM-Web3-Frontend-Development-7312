          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 border-l-2 border-subtle hover:border-axim-gold hover:bg-gradient-to-r from-white/5 to-transparent transition-all duration-300">
                ...
                <a href="https://quickdemandletter.com/" className="text-[0.75rem] text-axim-gold font-bold uppercase mt-3 inline-flex items-center gap-2 hover:gap-3 transition-all">
