    ...
    <div className="grid grid-cols-1 gap-4 min-h-[500px]">
      {nodes.map((node) => (
        <motion.div
          ...
          className={`cursor-pointer p-4 border transition-all duration-300 ${selectedNode?.id === node.id ? 'bg-axim-gold/10 border-axim-gold shadow-[0_0_30px_rgba(255,234,0,0.1)]' : 'bg-[#050505]/90 backdrop-blur-xl border-white/10 hover:border-white/20'}`}
        >
